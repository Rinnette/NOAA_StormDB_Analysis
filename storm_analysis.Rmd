...
```{r}
        ...
        sum(lessthan100_i$inj_sum)/sum(sd_edited$INJURIES)
```
...
Sum of damages for invalid events which were less than 1 billion contributed about 4% to total property damage.  So it was decided that names would be replaced for those events where property damage was over 1 billion.
